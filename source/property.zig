...
pub const Property = enum {
    ...
    pub fn affectedFields(comptime property: Property) []const struct { groups.Tag, []const @Type(.enum_literal) } {
        ...
        return comptime switch (property) {
            ...
            .@"align-self"             => &.{.{.box_style       , &.{.align_self}    }},
            ...
            .@"flex-wrap"              => &.{.{.box_style       , &.{.flex_wrap}     }},
            .@"flex-flow"               => &.{.{.box_style       , &.{.flex_direction, .flex_wrap} }},
            ...
            .font                     => &.{.{.font           , &.{.font_family, .font_size, .font_weight, .font_style, .line_height}}},
...
.@"overflow-wrap"          => &.{.{.font           , &.{.overflow_wrap} }},
.@"word-wrap"              => &.{.{.font           , &.{.overflow_wrap} }},
...
pub fn parseDeclarationsFromAst(
    ...
    ctx.custom_font_names = env.custom_font_names;
